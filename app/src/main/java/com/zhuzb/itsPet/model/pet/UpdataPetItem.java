...
public class UpdataPetItem implements Serializable {
    ...
    public UpdataPetItem(PetItem petItem) {
        this.pet_id =petItem.getPet_id();
        this.user_id = petItem.getUser_id();
        this.pet_code = petItem.getPet_code();
        this.pet_name = petItem.getPet_name();
        this.pet_user_img_url = petItem.getPet_user_img_url();
        this.pet_breed = petItem.getPet_breed();
        this.pet_grade = petItem.getPet_grade();
        this.pet_year = petItem.getPet_year();
        this.pet_month = petItem.getPet_month();
        this.pet_day = petItem.getPet_day();
        this.pet_bz = petItem.getPet_bz();
        this.pet_sex = petItem.getPet_sex();
        this.pet_value = petItem.getPet_value();
        this.follow_name = petItem.getFollow_name();
        this.status = petItem.getStatus();
        this.creation_date = petItem.getCreation_date();
        this.creation_by = petItem.getCreation_by();
        this.lastmodified_date = petItem.getLastmodified_date();
        this.lastmodified_by = petItem.getLastmodified_by();
    }
